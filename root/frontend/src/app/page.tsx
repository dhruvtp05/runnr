  ...
  return (
    <div className="min-h-screen bg-(--background) bg-grid overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 pt-28 pb-20">
        {/* Gradient orbs */}
        <div
          className="glow-orb w-[600px] h-[600px] -top-40 -left-40 bg-blue-500"
          aria-hidden
        />
        <div
          className="glow-orb w-[400px] h-[400px] top-1/2 -right-40 bg-violet-500"
          aria-hidden
        />
        <div
          className="glow-orb w-[300px] h-[300px] bottom-20 left-1/3 bg-pink-500/60"
          aria-hidden
        />
