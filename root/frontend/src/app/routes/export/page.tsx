        ...
        <div className="panel p-6 space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm text-body">
              ...
              <span className="font-medium text-heading">Export selected route → Download GPX</span>.
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-3">
              <div className="panel p-4 space-y-2">
                <h3 className="text-sm font-medium text-heading">Strava</h3>
                <ol className="list-decimal list-inside text-sm text-body space-y-1">
              ...
              <div className="panel p-4 space-y-2">
                <h3 className="text-sm font-medium text-heading">Garmin</h3>
                <ol className="list-decimal list-inside text-sm text-body space-y-1">
              ...
              <div className="panel p-4 space-y-2">
                <h3 className="text-sm font-medium text-heading">Apple Watch / Apple Fitness</h3>
                <p className="text-sm text-body">
